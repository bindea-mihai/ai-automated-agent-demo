using InsuranceDemo.Application.Common.Models;
using InsuranceDemo.Application.TodoItems.Commands.CreateTodoItem;
using InsuranceDemo.Application.TodoItems.Commands.DeleteTodoItem;
using InsuranceDemo.Application.TodoItems.Commands.UpdateTodoItem;
using InsuranceDemo.Application.TodoItems.Commands.UpdateTodoItemDetail;
using InsuranceDemo.Application.TodoItems.Queries.GetTodoItemsWithPagination;
